...
func init() {
	codegen.Register(codegen.Registration{
		Name:  "github.com/weaver/learn/cmd/components/Reverser",
		...
		ClientStubFn: func(stub codegen.Stub, caller string) any {
			return reverser_client_stub{stub: stub, reverseMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/weaver/learn/cmd/components/Reverser", Method: "Reverse"})}
		},
...
func (s reverser_local_stub) Reverse(ctx context.Context, a0 string) (r0 string, err error) {
	...
	if span.SpanContext().IsValid() {
		...
		ctx, span = s.tracer.Start(ctx, "components.Reverser.Reverse", trace.WithSpanKind(trace.SpanKindInternal))
		defer func() {
			if err != nil {
...
func (s reverser_client_stub) Reverse(ctx context.Context, a0 string) (r0 string, err error) {
	...
	if span.SpanContext().IsValid() {
		// Create a child span for this method.
		ctx, span = s.stub.Tracer().Start(ctx, "components.Reverser.Reverse", trace.WithSpanKind(trace.SpanKindClient))
	}
